...
![Mad](Images/rk_wtf.jpg){fig-alt="Agitated Roy Kent saying what the f-ck"}
:::

::: {.fragment}

![Sad](Images/rk_wtf.jpg){fig-alt="Agitated Roy Kent saying what the f-ck"}
...
![Happy](Images/rk_wtf.jpg){fig-alt="Agitated Roy Kent saying what the f-ck"}
:::

::: {.fragment}


![Amused](Images/rk_wtf.jpg){fig-alt="Agitated Roy Kent saying what the f-ck"}
:::

::: {.fragment}

![Loving](Images/rk_wtf.jpg){fig-alt="Agitated Roy Kent saying what the f-ck"}
...
![Surprised](Images/rk_wtf.jpg){fig-alt="Agitated Roy Kent saying what the f-ck"}
:::

::: {.fragment}


![Thoughtful](Images/rk_wtf.jpg){fig-alt="Agitated Roy Kent saying what the f-ck"}
:::

::: {.fragment}


![Joyous](Images/rk_wtf.jpg){fig-alt="Agitated Roy Kent saying what the f-ck"}
:::
...
1. Hold the tension in your story
2. Add a third variable to your plot
3. Turn your viz to a dashboard style report
4. Make your viz more accessible
5. Add layers to your story
6. Give your stakeholders more control to explore and arrive at insights
...
[Mastodon: @IandLoveandData](https://fosstodon.org/@deepsha)
...
![](Images/ted-lasso-believe.gif){width="100%" fig-align="center"  fig-alt="Ted Lasso pointing to a sign that says - Believe"}
:::
